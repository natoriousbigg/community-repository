# ----------------------------------------------------------------------------------------------------
# Name: Whisper.cpp - Binary and Base Model (IntelGPU)
# Description: Installs the whisper.cpp binary with Intel OneAPI support and downloads the ggml-base
...
VERSION="1.8.2"
BINARY_URL="https://github.com/natoriousbigg/whisper.cpp/releases/download/v${VERSION}/whisper-cli-ubuntu-x64-oneapi.zip"
