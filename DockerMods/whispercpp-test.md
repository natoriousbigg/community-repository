...
- Both commands rely on the install locations defined by the Whisper.cpp DockerMod: `/usr/local/bin/whispercpp` and `/app/data/whispercpp/models/ggml-small.bin`.
